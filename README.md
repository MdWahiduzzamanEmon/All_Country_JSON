...
Check out the [interactive example](example.html) included in this repository to see a live demo of searching and displaying country data!
...
This data is provided as-is for public use. Please verify critical information independently.
